...
namespace KatalogOnline.DataBelanja {
    public partial class KeranjangBelanja : System.Web.UI.Page {
        ...
        protected void HitungTotal() {
            ...
            for(x = 0; x <= gvKeranjang.Rows.Count - 1; x++) {
                ...
                Total += System.Convert.ToDouble(gvKeranjang.Rows[x].Cells[7].Text.ToString().Replace(" ", "").Replace("$","").Replace("Rp", ""));
            }
